  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-20 text-center">
      ...
      <p className="mb-6 text-muted-foreground">
        The listing “{slug.replace(/-/g, " ")}” is no longer available.
      </p>
...
function BusinessError({ reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-20 text-center">
      ...
      <p className="mb-6 text-muted-foreground">We couldn’t load this business right now.</p>
      <button
