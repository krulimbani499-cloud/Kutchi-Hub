...
function HomePage() {
  ...
  const featureTiles = [
    { key: "b2b", title: t("tile.b2b"), subtitle: t("tile.b2bSub"), bg: "from-blue-500 to-blue-600", img: tileB2B },
    { key: "repairs", title: t("tile.repairs"), subtitle: t("tile.repairsSub"), bg: "from-slate-700 to-slate-900", img: tileRepairs },
    { key: "realestate", title: t("tile.realEstate"), subtitle: t("tile.realEstateSub"), bg: "from-indigo-500 to-indigo-700", img: tileRealEstate },
    { key: "doctors", title: t("tile.doctors"), subtitle: t("tile.doctorsSub"), bg: "from-emerald-500 to-emerald-700", img: tileDoctors },
  ];
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:py-8">
          <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center sm:gap-4">
            <h1 className="text-xl font-extrabold text-foreground sm:text-2xl">
              <span className="animate-text-shine font-extrabold">{t("home.searchTagline")}</span>
            </h1>
            ...
            >
              ...
              <span className="relative text-sm font-semibold text-foreground">{t("home.downloadApp")}</span>
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)]">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange-100 via-orange-50 to-orange-100 animate-gradient-pan p-6 sm:p-8">
            <div className="max-w-[70%]">
              <p className="text-xs font-bold uppercase tracking-wider text-[#ff6a00]">{t("home.featured")}</p>
              <h3 className="mt-1 text-lg font-extrabold text-foreground sm:text-2xl">
                {t("home.listYourBusiness")}
              </h3>
              <p className="mt-1 text-sm text-muted-foreground">
                {t("home.listYourBusinessDesc")}
              </p>
          ...
          <div className="rounded-2xl border-2 border-amber-400/40 bg-gradient-to-br from-amber-50 via-orange-50 to-background p-5 sm:p-6">
            <div className="mb-5 flex items-center justify-between gap-2">
              <h2 className="flex items-center gap-2 text-base font-bold text-foreground sm:text-lg">
                ...
                {t("home.platinumSpotlight")}{city ? ` ${t("home.in")} ${city}` : ""}
              </h2>
              <span className="text-xs font-medium text-muted-foreground">{t("home.premiumPartners")}</span>
            </div>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border-2 border-[#ff6a00]/20 bg-gradient-to-br from-[#fff4ea] to-background p-5 sm:p-6">
            <div className="mb-5 flex items-center justify-between gap-2">
              <h2 className="flex items-center gap-2 text-base font-bold text-foreground sm:text-lg">
                ...
                {t("home.topOffers")}{city ? ` ${t("home.in")} ${city}` : ""}
              </h2>
              <a
  ...
  return (
    <Reveal as="section" className="mx-auto w-full max-w-7xl px-4 py-6">
      <div className="rounded-2xl border border-border bg-background p-5 sm:p-6">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="flex items-center gap-2 text-base font-bold text-foreground sm:text-lg">
            <Calendar className="h-5 w-5 text-primary" /> {t("home.upcomingEvents")}
          </h2>
          <Link to="/events" className="text-sm font-medium text-primary hover:underline">{t("home.viewAll")} →</Link>
        </div>
