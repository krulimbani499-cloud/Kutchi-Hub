    ...
    <div className="flex flex-col bg-muted/30">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-6">
        <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)]">
          {/* Promo banner */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-100 to-green-50 p-6 sm:p-8">
            <div className="max-w-[70%]">
              <p className="text-xs font-bold uppercase tracking-wider text-green-700">Featured</p>
              ...
              <Button size="sm" className="mt-4 rounded-full bg-[#16a34a] text-white hover:bg-[#15803d]" asChild>
                <Link to="/business/new">
                  Get Started <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
            </div>
            <Building2 className="absolute -right-4 -bottom-4 h-40 w-40 text-green-200" />
          </div>
