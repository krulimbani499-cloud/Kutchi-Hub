          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              <h1 className="text-4xl font-extrabold leading-tight text-foreground md:text-5xl">
                List Your Business <span className="text-[#f26c22]">for FREE</span>
              </h1>
              <p className="mt-3 text-lg text-muted-foreground">
                with Kutchi Hub — Your Local Kutchi Search Engine
              </p>

              <div className="mt-6 rounded-xl border border-[#f26c22]/40 bg-orange-50/70 px-4 py-3 text-sm font-medium text-foreground">
