...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kutchi Hub — Kutch Ka Local Business Directory | Launching Soon" },
      { name: "description", content: "Kutchi Hub — Kutch ka apna local business directory. Bhuj, Gandhidham, Anjar, Mandvi, Mundra, Kapadvanj ke restaurants, doctors, grocery, shops aur services. Launching soon." },
      ...
      { property: "og:title", content: "Kutchi Hub — Kutch Ka Local Business Directory | Launching Soon" },
      { property: "og:description", content: "Kutchi Hub — Kutch ka apna local business directory. Restaurants, doctors, grocery, shops aur services. Launching soon." },
