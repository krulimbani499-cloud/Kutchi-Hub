...
// Managed Google/Apple OAuth only works on Lovable-hosted origins
// (*.lovable.app / *.lovableproject.com) or a custom domain connected in Lovable.
// On other hosts (e.g. Vercel) the broker rejects the redirect_uri → "authorization failed".
function isOAuthSupportedHost() {
...
export function AuthForms() {
  ...
  useEffect(() => {
    setShowSocialAuth(!isRunningInsideMobileApp() && isOAuthSupportedHost());
  }, []);
